...
function make_path() {
   ...
   for (var seg = 0; seg < mod.path.length; ++seg) {
      ...
      total_sec += toolxyz.move(x, y, z) / (mod.units * speed)
      //
      // move down
      //
   ...
   //
   var x = mod.units*parseFloat(mod.hx.value)
   var y = mod.units*parseFloat(mod.hy.value)
   var z = mod.units*parseFloat(mod.hz.value)
   total_sec += toolxyz.move(x, y, z) / (mod.units * speed)
   str += "PA;PA;!PZ0,"+z+";PU"+x+","+y+";!MC0;"
   //
   // print time
   //
   mod.timeTxt.textContent = toHHMMSS(total_sec)
   //
   // output string
   //
   var obj = {}
