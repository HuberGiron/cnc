...
// Updated: Rob Duarte
// Date: Feb 1 2023
// Comments: adapted for Carbide Nomad
//
...
(function(){
  ...
  // name
  //
  var name = 'path to Carbide Nomad G-code'
  //
  // initialization
  //
  var init = function() {
  ...
  function make_path() {
     ...
     str += "(G49)\n" // cancel tool length compensation // RKD: removed for Carbide Nomad
     str += "G54\n" // coordinate system 1
     str += "(G80)\n" // cancel canned cycles // RKD: removed for Carbide Nomad
    ...
    //     str += "M08\n" // coolant on
     ...
     //str += "G04 P1\n" // give spindle 1 second to spin up // some interpreters hae trouble with this
     // RKD: G04 definitely hangs up the Carbide Nomad (or Carbide Motion CAM software)
     //
     // follow segments
     //
